    ...
    <div
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div class="bg-bg-darker/60 rounded-2xl p-6 border border-white/5 relative group">
          <div class="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl">
          </div>
          <p class="text-sm uppercase tracking-widest text-text-light/50 font-bold mb-2">
            Skorunuz
          </p>
          <p class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">
            {{ quizStore.score }}
          </p>
        </div>

        <div class="bg-bg-darker/60 rounded-2xl p-6 border border-white/5 relative group">
          <div class="absolute inset-0 bg-success/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl">
          </div>
          <p class="text-sm uppercase tracking-widest text-text-light/50 font-bold mb-2">
            Doğruluk Oranı
          </p>
        ...
        <div class="bg-bg-darker/60 rounded-2xl p-6 border border-white/5 relative group">
          <div class="absolute inset-0 bg-danger/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl">
          </div>
          <p class="text-sm uppercase tracking-widest text-text-light/50 font-bold mb-2">
            Cevaplar
          </p>
